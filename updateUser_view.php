    ...
    <div class="container">
        <div class="page-add-user">
            ...
            <h3>وبسایت فروشگاه لوازم جانبی رایانه</h3>
                ...
                <input class="inputs" type="text" id="user_name" name="username" value="<?php echo $username_a; ?>">
                ...
                <label for="address_user">آدرس منزل یا محل کار خود را ویرایش کنید</label>
                <textarea name="address_user" id="address_user" ><?php echo $address_a; ?></textarea >
