            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="item">دوستان</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="icon"><i class="fas fa-tachometer-alt"></i></span>
                        <span class="item">عملکرد</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="icon"><i class="fas fa-database"></i></span>
                        <span class="item">توسعه</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="item">پنل ادمین</span>
                    </a>
                </li>
                <li>
                    <a href="#">
...
<script src="assets/js/userPanel.js">
